...
import com.lidroid.xuansu.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.lidroid.xuansu.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.lidroid.xuansu.db.table.Id>();

    /* package */
    static synchronized com.lidroid.xuansu.db.table.Id getId(Class<?> entityType) {
        ...
        com.lidroid.xuansu.db.table.Id id = new com.lidroid.xuansu.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.lidroid.xuansu.db.table.Id id = getId(entityType);
