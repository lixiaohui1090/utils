...
package com.lidroid.xuansu.db.table;

import android.text.TextUtils;
import com.lidroid.xuansu.db.annotation.*;
import com.lidroid.xuansu.db.annotation.Column;
import com.lidroid.xuansu.db.annotation.Finder;
import com.lidroid.xuansu.db.annotation.Foreign;
import com.lidroid.xuansu.db.annotation.Id;
import com.lidroid.xuansu.db.converter.ColumnConverter;
import com.lidroid.xuansu.db.converter.ColumnConverterFactory;
import com.lidroid.xuansu.db.sqlite.FinderLazyLoader;
import com.lidroid.xuansu.db.sqlite.ForeignLazyLoader;
import com.lidroid.xuansu.util.LogUtils;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.lidroid.xuansu.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.lidroid.xuansu.db.table.Finder finderColumn) {
